...
def main():
    st.title("Welcome to Surgery.AI!")
    ...
    col1, col2 = st.columns(2)
    with col2:
        st.header("Transforming the cosmatic surgery experiance")
        st.write("Our Surgery AI model generates realistic before and after images of cosmetic surgery.")
